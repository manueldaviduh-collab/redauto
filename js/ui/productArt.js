...
// generador), así que se renderiza un vector detallado por categoría —
// el sustituto más honesto a una foto de estudio real.
const DEFS = `
  <linearGradient id="pa-metal" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0%" stop-color="#f4f5f7"/>
    <stop offset="45%" stop-color="#c9cdd4"/>
    <stop offset="55%" stop-color="#aeb3bb"/>
    <stop offset="100%" stop-color="#8a8f98"/>
  </linearGradient>
  <linearGradient id="pa-metal-dark" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0%" stop-color="#6b7078"/>
    <stop offset="100%" stop-color="#33363c"/>
  </linearGradient>
  <radialGradient id="pa-disc" cx="38%" cy="32%" r="75%">
    <stop offset="0%" stop-color="#eef0f3"/>
    <stop offset="55%" stop-color="#c3c8cf"/>
    <stop offset="100%" stop-color="#93989f"/>
  </radialGradient>
  <linearGradient id="pa-pad" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0%" stop-color="#3a3d42"/>
    <stop offset="100%" stop-color="#1c1e21"/>
  </linearGradient>
  <linearGradient id="pa-red" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0%" stop-color="#ef5350"/>
    <stop offset="100%" stop-color="#c62828"/>
  </linearGradient>
  <linearGradient id="pa-bottle" x1="0" y1="0" x2="1" y2="0">
    <stop offset="0%" stop-color="#f2f2f2"/>
    <stop offset="18%" stop-color="#ffffff"/>
    <stop offset="55%" stop-color="#e2e3e5"/>
    <stop offset="100%" stop-color="#c7c9cc"/>
  </linearGradient>
  <linearGradient id="pa-glass" x1="0" y1="0" x2="0" y2="1">
    <stop offset="0%" stop-color="#fff7e6"/>
    <stop offset="60%" stop-color="#ffe9b8"/>
    <stop offset="100%" stop-color="#f4c96b"/>
  </linearGradient>
  <linearGradient id="pa-rubber" x1="0" y1="0" x2="0" y2="1">
...
const ART = {
  frenos: () => wrap(`
    <circle cx="118" cy="120" r="72" fill="url(#pa-disc)" stroke="#9aa0a8" stroke-width="1.5"/>
    ...
    <circle cx="118" cy="120" r="30" fill="url(#pa-metal-dark)"/>
    ...
    ${[0, 72, 144, 216, 288].map((deg) => {
      ...
      return `<circle cx="${x.toFixed(1)}" cy="${y.toFixed(1)}" r="3.6" fill="url(#pa-metal)"/>`;
    }).join('')}
    <circle cx="118" cy="120" r="9" fill="url(#pa-metal)"/>
    <g transform="translate(154 150) rotate(28)">
      <rect x="-8" y="-46" width="52" height="92" rx="10" fill="url(#pa-pad)"/>
      <rect x="-8" y="-46" width="52" height="14" rx="6" fill="url(#pa-metal)"/>
      <rect x="-2" y="-26" width="40" height="62" rx="4" fill="#111214"/>
      <circle cx="18" cy="-39" r="3" fill="#7c828b"/>
    </g>
  `),
  motor: () => wrap(`
    <rect x="98" y="30" width="44" height="26" rx="4" fill="url(#pa-metal)"/>
    ...
    <rect x="108" y="56" width="24" height="16" fill="url(#pa-metal-dark)"/>
    ...
    <rect x="106" y="128" width="28" height="46" rx="3" fill="url(#pa-metal-dark)"/>
    <rect x="112" y="174" width="16" height="10" fill="url(#pa-metal)"/>
    <path d="M120 184 l7 14 -7 -4 -7 4 z" fill="url(#pa-red)"/>
  `),
  suspension: () => wrap(`
    <rect x="112" y="30" width="16" height="40" rx="4" fill="url(#pa-metal)"/>
    <path d="M120 66
      C 90 74, 90 90, 120 98
      C 150 106, 150 122, 120 130
      C 90 138, 90 154, 120 162
      C 150 170, 150 186, 120 194"
      fill="none" stroke="url(#pa-metal-dark)" stroke-width="10" stroke-linecap="round"/>
    <rect x="108" y="192" width="24" height="14" rx="3" fill="url(#pa-metal)"/>
    <rect x="115" y="60" width="10" height="150" rx="5" fill="url(#pa-red)" opacity="0.92"/>
    <rect x="117" y="60" width="2.5" height="150" fill="#ffffff" opacity="0.35"/>
  `),
  baterias: () => wrap(`
    <rect x="52" y="86" width="136" height="98" rx="10" fill="url(#pa-metal-dark)"/>
    <rect x="52" y="86" width="136" height="98" rx="10" fill="none" stroke="#000" stroke-opacity="0.3"/>
    <rect x="64" y="98" width="112" height="58" rx="4" fill="url(#pa-red)" opacity="0.16"/>
    <rect x="64" y="98" width="112" height="4" fill="#ffffff" opacity="0.18"/>
    <rect x="72" y="66" width="20" height="24" rx="3" fill="url(#pa-metal)"/>
    <rect x="148" y="66" width="20" height="24" rx="3" fill="url(#pa-metal)"/>
    <circle cx="82" cy="66" r="8" fill="url(#pa-metal)"/>
    <circle cx="158" cy="66" r="8" fill="url(#pa-metal)"/>
    ...
    <rect x="64" y="164" width="112" height="10" rx="3" fill="url(#pa-red)"/>
  `),
  aceites: () => wrap(`
    <path d="M100 46 h40 v20 l10 12 v106 a10 10 0 0 1 -10 10 h-40 a10 10 0 0 1 -10 -10 v-106 l10 -12 z"
      fill="url(#pa-bottle)" stroke="#c3c5c8" stroke-width="1.2"/>
    <rect x="104" y="34" width="32" height="16" rx="3" fill="url(#pa-metal)"/>
    <rect x="100" y="78" width="40" height="72" rx="4" fill="#ffffff" stroke="#e3e4e6" stroke-width="1"/>
    <rect x="106" y="88" width="28" height="7" rx="2" fill="url(#pa-red)"/>
    <rect x="106" y="100" width="28" height="4" rx="2" fill="#c9cbce"/>
    <rect x="106" y="108" width="20" height="4" rx="2" fill="#c9cbce"/>
    <rect x="106" y="134" width="28" height="10" rx="2" fill="url(#pa-red)" opacity="0.85"/>
    <path d="M170 150 c0 10 -16 10 -16 0 c0 -8 8 -16 8 -16 s8 8 8 16z" fill="#ef5350" opacity="0.85"/>
  `),
  filtros: () => wrap(`
    <ellipse cx="120" cy="60" rx="46" ry="14" fill="url(#pa-metal)"/>
    <rect x="74" y="60" width="92" height="104" fill="url(#pa-metal-dark)"/>
    ${Array.from({ length: 10 }, (_, i) => `<rect x="${78 + i * 9}" y="60" width="3.4" height="104" fill="#000" opacity="0.16"/>`).join('')}
    <ellipse cx="120" cy="164" rx="46" ry="14" fill="url(#pa-metal-dark)"/>
    <rect x="90" y="42" width="60" height="22" rx="5" fill="url(#pa-red)"/>
    <ellipse cx="120" cy="42" rx="30" ry="9" fill="#ef5350"/>
    <ellipse cx="120" cy="60" rx="46" ry="14" fill="none" stroke="#00000022" stroke-width="1"/>
  `),
  iluminacion: () => wrap(`
    <ellipse cx="120" cy="92" rx="38" ry="46" fill="url(#pa-glass)" opacity="0.95"/>
    ...
    <rect x="104" y="130" width="32" height="20" rx="3" fill="url(#pa-metal)"/>
    <rect x="98" y="150" width="44" height="30" rx="6" fill="url(#pa-metal-dark)"/>
    ${[0, 1, 2].map((i) => `<rect x="${104 + i * 12}" y="180" width="6" height="16" rx="2" fill="url(#pa-metal)"/>`).join('')}
    <circle cx="120" cy="94" r="10" fill="#fff4cf" opacity="0.9"/>
  `),
  cauchos: () => wrap(`
    <circle cx="120" cy="120" r="82" fill="url(#pa-rubber)"/>
    ...
    <circle cx="120" cy="120" r="52" fill="url(#pa-metal)"/>
    <circle cx="120" cy="120" r="52" fill="none" stroke="#8a8f98" stroke-width="1"/>
    <circle cx="120" cy="120" r="16" fill="url(#pa-metal-dark)"/>
